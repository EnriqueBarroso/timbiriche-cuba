    ...
    <div className="bg-gray-50 min-h-screen py-16 px-4">
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="bg-gray-900 p-8 rounded-2xl border border-gray-900 shadow-2xl relative overflow-hidden text-white transform md:-translate-y-4">
          ...
          <Link
            href="https://wa.me/34666953174?text=Hola,%20me%20interesa%20unirme%20a%20la%20lista%20de%20espera%20para%20el%20plan%20Vendedor%20Pro%20en%20LaChopin."
            target="_blank"
            rel="noopener noreferrer"
            className="block text-center w-full py-3 px-6 rounded-xl bg-blue-600 font-bold text-white hover:bg-blue-500 transition-colors"
          >
